        ...
        definitions.put(
                ...
                new RoleTemplatePolicy(
                        ...
                        EnumSet.of(
                                ...
                                PermissionCode.BASE_DICT_READ,
                                PermissionCode.BASE_DICT_CREATE,
                                PermissionCode.BASE_DICT_UPDATE,
                                PermissionCode.BASE_DICT_DELETE,
                                PermissionCode.BASE_REGION_READ,
                                PermissionCode.BASE_REGION_CREATE,
                                PermissionCode.BASE_REGION_UPDATE,
                                PermissionCode.BASE_REGION_DELETE,
                                PermissionCode.BASE_SERVICE_TYPE_READ,
                                PermissionCode.BASE_SERVICE_TYPE_CREATE,
                                PermissionCode.BASE_SERVICE_TYPE_UPDATE,
                                PermissionCode.BASE_SERVICE_TYPE_DELETE,
                                PermissionCode.REVIEW_DOMAIN_ASSIGNMENT_MANAGE,
                                PermissionCode.ACCESS_GRANT_REQUEST_SUBMIT,
