...
public class ProviderServiceCatalogController {
    ...
    public ProviderServiceCatalogController(ServiceCatalogService serviceCatalogService) {
    ...
    public ApiResponse<ServiceListResponse> list(@AuthenticationPrincipal AuthenticatedUser currentUser) {
        return ApiResponse.success(
                serviceCatalogService.listProviderServices(currentUser),
    ...
    public ApiResponse<ServiceSummaryResponse> create(
        ...
        return ApiResponse.success(
                serviceCatalogService.createProviderService(currentUser, request),
                MDC.get(RequestIdFilter.REQUEST_ID));
    }
    ...
    public ApiResponse<ServiceSummaryResponse> update(
            ...
            @Valid @RequestBody ServiceSaveRequest request) {
        return ApiResponse.success(
                serviceCatalogService.updateProviderService(currentUser, serviceId, request),
                MDC.get(RequestIdFilter.REQUEST_ID));
    }
}
